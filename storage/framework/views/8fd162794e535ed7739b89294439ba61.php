<?php $__env->startSection("title", "فروش"); ?>
<div>
    <div class="row">
        <div class="col-12">
            <div class="card mb-4 min-vh-85">
                <div class="card-header pb-0">
                    <h4 class="border-bottom mb-4 pb-3">فروش</h4>
                </div>
                            ...
                            <?php else: ?>
                                ...
                                <table class="table align-items-center mb-0 data-table">
                                    ...
                                    <tr>
                                        ...
                                        <th class="text-center text-secondary text-xs font-weight-bolder opacity-7">تاریخ فروش</th>
                                    </tr>
                                    </thead>
                                    <tbody>
                                    <?php $genratedID = 0 ?>
...
<?php $__env->stopPush(); ?>
<?php /**PATH C:\Users\jawed\OneDrive\Desktop\NewProject\StockManagement\resources\views/livewire/sell.blade.php ENDPATH**/ ?>