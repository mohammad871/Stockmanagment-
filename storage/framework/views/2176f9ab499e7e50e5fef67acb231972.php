<?php $__env->startSection("title", "برگشتی"); ?>
<div>
    <div class="row">
        <div class="col-12">
            <div class="card mb-4 min-vh-85">
                <div class="card-header pb-0">
                    <h4 class="border-bottom mb-4 pb-3">برگشتی</h4>
                </div>
                ...
                <div class="card-body px-md-4 pt-0 pb-2">
                            ...
                            <?php if(count($records) > 0): ?>
                                <table class="table align-items-center mb-0 data-table">
                                    ...
                                    <tr>
                                        ...
                                        <th class="text-center text-secondary text-xs font-weight-bolder opacity-7">تاریخ برگشت</th>
                    ...
                    <?php else: ?>
                        ...
                        <form wire:submit.prevent="<?php echo e($operationType == "edit" ? "update" : "store"); ?>" class="<?php echo e($operationType != "edit" ? "mt-5" : ''); ?>">
                            <div class="col-md-3 mb-2 generate-part">
...
<?php $__env->startPush('scripts'); ?>
    <script>
        window.addEventListener("alert", (data)=> {
...
<?php $__env->stopPush(); ?>
<?php /**PATH C:\Users\jawed\OneDrive\Desktop\NewProject\StockManagement\resources\views/livewire/return-operation.blade.php ENDPATH**/ ?>