<?php $__env->startSection("title", "انبار / گدام"); ?>
<div>
    <?php if($showModal): ?>
            ...
            <form wire:submit.prevent="<?php echo e($typeModal == "add" ?  "store" : "update"); ?>" class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel">
                        <?php echo e($typeModal == "add" ? "ایجاد انبار/گدام جدید" : " تغیر انبار/گدام "."(".$stock->name.")"); ?>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group">
                                <label for="stockName">نام انبار</label>
                                <input
                                    type="text"
        ...
        <div class="col-12">
            <div class="card mb-4 min-vh-85">
                <div class="card-header pb-0">
                    <h4 class="border-bottom mb-4 pb-3">گدام / انبار</h4>
                </div>
                            ...
                            <tr>
                                ...
                                <td class="align-middle text-center">
                                    <a href="javascript:void(0);" class="text-secondary font-weight-bold text-xs" data-toggle="tooltip" data-original-title="Edit user">
                                        ...
                                        <span class="badge bg-gradient-danger" onclick="confirm('آیا می خواهید ریکارد مربوطه حذف شود؟') || event.stopImmediatePropagation()"  wire:click="delete(<?php echo e($record->id); ?>)">
                                            حذف
                                        </span>
                                    </a>
                                </td>
...
<?php /**PATH C:\Users\jawed\OneDrive\Desktop\StockManagement\resources\views/livewire/stock.blade.php ENDPATH**/ ?>